...
$config = array(
    ...
    |
    */
    // 'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://localhost/LaravelDemo/public". @$_SERVER['HTTP_HOST'],
    // 'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://toyota.test:8080",
    'base_url' =>'/',
    /*
    |--------------------------------------------------------------------------
