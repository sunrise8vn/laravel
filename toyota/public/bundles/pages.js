function setUpFormValidate() {
    ...
    $("#testDriveInTools").validate({
        submitHandler: function() {
            ...
            l = $("#ddlAdrress").val();
            ($(".fullname").text(s + " " + p + " " + h), 
                $(".phone").text(c.toLowerCase()), 
                $(".email").text(o.toLowerCase()), $(".mauxe").text(e), 
                $(".address").text(l), 
                $(".ghichu").text(y), 
                CheckValueTestDrive(u, t, i, f, w, s, h, o, c)) && (0 < $("#chkHaveLicense:checkbox:checked").length 
                ...
                b = $("#ddlAdrress").find("option:selected").attr("data-branchid"), 
                angular.element($(".btnSend")).scope().PostTestDrive(u, s, p, h, o, c, v, w, y, l, n, b)) : showErrorbyAlert("Đăng ký lái thử", "<p>Xin vui lòng chọn ô Tôi đã có giấy phép lái xe ô tô hợp lệ!<\/p>", ""))
        },
        highlight: function(n) {
            HighLightError(n)
        },
...
function CheckValue01TestDrive() {
    ...
    return $("#tab_testdrive_01 .chkCats:checked").each(function() {
        n += $(this).data("idcat") + ","
        }), "" != (n = n.replace(/,$/, "")) || (showErrorbyAlert("Đăng ký lái thử", "<p>Vui lòng chọn tối thiểu 1 mẫu xe!", ""), 
        ...
        $("#tab_testdrive_01").css("display", "block"), !1)
}
...
function CheckValue02TestDrive() {
    var h = $("#inputDate").val(),
        ...
        c = $("#timePicker").val(),
        s;
    if (CheckIfIsMobile() && (u = (r = h.split("-"))[2], t = r[1], n = r[0]), "" == u || "" == t || "" == n) {
        return showErrorbyAlert("Đăng ký lái thử", "<p>Vui lòng chọn ngày dự kiến!<p>", "inputDate"), 
        $(".page_testdrive .tab").find("a").removeClass("active"), 
    ...
    var i = new Date,
        ...
        l = i.getHours(),
        a = i.getMinutes();
    return (15 == l && 15 < a || 15 < l) && (i.setDate(i.getDate() + 1), 
        e += 1, 
        n < f || (f = n && t < o) || (f = n && o == t && u < e)) ? (showErrorbyAlert("Đăng ký lái thử", "<p>Ngày dự kiến phải lớn hơn ngày hiện tại!<p>", ""), 
        $(".page_testdrive .tab").find("a").removeClass("active"), 
        $("a[href*='tab_testdrive_02']").addClass("active"), 
        $(".page_testdrive .content-tab").css("display", "none"), 
        $("#tab_testdrive_02").css("display", "block"), 
        $("#inputDate").focus(), !1) : n <= f && t <= o && u < e ? (showErrorbyAlert("Đăng ký lái thử", "<p>Ngày dự kiến phải lớn hơn hoặc bằng ngày hiện tại!<p>", ""), 
        $(".page_testdrive .tab").find("a").removeClass("active"), 
        $("a[href*='tab_testdrive_02']").addClass("active"), 
        $(".page_testdrive .content-tab").css("display", "none"), 
        $("#tab_testdrive_02").css("display", "block"), 
        $("#inputDate").focus(), !1) : 31 < parseInt(u) || parseInt(u) < 1 || 12 < parseInt(t) || 4 < n.length || parseInt(t) < 1 || parseInt(n) < 1 ? (showErrorbyAlert("Đăng ký lái thử", "<p>Ngày dự kiến chưa đúng!<p>", "inputDate"), 
        $(".page_testdrive .tab").find("a").removeClass("active"), 
        $("a[href*='tab_testdrive_02']").addClass("active"), 
        $(".page_testdrive .content-tab").css("display", "none"), 
        $("#tab_testdrive_02").css("display", "block"), 
        $("#inputDate").focus(), !1) : "0" == c || null == c ? (showErrorbyAlert("Đăng ký lái thử", "<p>Vui lòng chọn thời gian dự kiến!<p>", "timePicker"), 
        $(".page_testdrive .tab").find("a").removeClass("active"), 
        $("a[href*='tab_testdrive_02']").addClass("active"), 
        $(".page_testdrive .content-tab").css("display", "none"), 
        $("#tab_testdrive_02").css("display", "block")//,
        $("#timePicker").focus(), !1) : (s = $("#ddlAdrress").val(), "" !== s && null != s || (showErrorbyAlert("Đăng ký lái thử", "<p>Vui lòng chọn địa điểm", ""), 
        $(".page_testdrive .tab").find("a").removeClass("active"), 
        $("a[href*='tab_testdrive_02']").addClass("active"), 
        $(".page_testdrive .content-tab").css("display", "none"), 
        $("#tab_testdrive_02").css("display", "block"), 
...
function CheckValue02ServiceRegister() {
    ...
    return (u.getHours(), 
        u.getMinutes(), 
        n < f || (f = n && i < h) || (f = n && h == i && r < l)) ? (showErrorbyAlert("Đặt lịch hẹn dịch vụ", "<p>Ngày dự kiến phải lớn hơn hoặc bằng ngày hiện tại!<p>", ""), 
        ...
        $("#inputDate").focus(), !1) : (e = $("#hourPicker").val(), 31 < parseInt(r) || parseInt(r) < 1 || 12 < parseInt(i) || 4 < n.length || parseInt(i) < 1) ? (showErrorbyAlert("Đặt lịch hẹn dịch vụ", "<p>Ngày dự kiến chưa đúng!<p>", ""), 
        $(".page_dangkydichvu .tab").find("a").removeClass("active"), 
        $("a[href*='tab_dangkydichvu_02']").addClass("active"), 
        $(".page_dangkydichvu .content-tab").css("display", "none"), 
        $("#tab_dangkydichvu_02").css("display", "block"), 
        $("#inputDate").focus(), !1) : "0" == e || null == e ? (showErrorbyAlert("Đặt lịch hẹn dịch vụ", "<p>Vui lòng chọn thời gian dự kiến!<p>", ""), 
        $(".page_dangkydichvu .tab").find("a").removeClass("active"), 
        $("a[href*='tab_dangkydichvu_02']").addClass("active"), 
        $(".page_dangkydichvu .content-tab").css("display", "none"), 
        $("#tab_dangkydichvu_02").css("display", "block"), 
        $("#timePicker").focus(), !1) : (o = $("#ddlAdrress").val(), "" === o || null == o) ? (showErrorbyAlert("Đặt lịch hẹn dịch vụ", "<p>Vui lòng chọn địa điểm", ""), 
        $(".page_dangkydichvu .tab").find("a").removeClass("active"), 
        $("a[href*='tab_dangkydichvu_02']").addClass("active"), 
        $(".page_dangkydichvu .content-tab").css("display", "none"), 
        $("#tab_dangkydichvu_02").css("display", "block"), 
        $("#ddlAdrress").focus(), !1) : (c = new Date, "" == n || !(parseInt(n) < 1950 || parseInt(n) > c.getFullYear()) || (showErrorbyAlert("Đặt lịch hẹn dịch vụ", "<p>Vui lòng nhập năm sản xuất<p> <i>(Từ 1950 đến nay)<\/i>", "inputYearCar"), 
        $(".page_dangkydichvu .tab").find("a").removeClass("active"), 
        $("a[href*='tab_dangkydichvu_03']").addClass("active"), 
        $(".page_dangkydichvu .content-tab").css("display", "none"), 
        $("#tab_dangkydichvu_03").css("display", "block"), 
        $("#inputYearCar").focus(), !1))
}
