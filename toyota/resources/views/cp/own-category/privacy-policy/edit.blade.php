...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Chỉnh sửa chính sách bảo mật thông tin cá nhân
      </h1>
      {{-- <ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-xs-12">
        	<div class="box">
                ...
                <div class="box-body">
                	<div class="row">
		            	<form action="cp/privacy-policy/edit/{{$privacyPolicy->id}}" method="POST" enctype="multipart/form-data">
		                    @csrf
	                        <div class="col-md-12">
	                            <div class="form-group">
	                                <label>Nội dung</label>
	                                <textarea name="content" style="width: 100%; height: 800px;">{{$privacyPolicy->content}}</textarea>
	                            </div>
	                        </div>
