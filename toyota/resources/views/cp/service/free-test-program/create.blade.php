...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Thêm bài viết chương trình kiểm tra miễn phí
      </h1>
      {{-- <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
        	<div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
		            	<form action="{{ route('service.free-test-program.postCreate') }}" method="POST" enctype="multipart/form-data">
		                    @csrf
	                        <div class="col-md-12">
	                            <div class="form-group">
	                                <label>Tiêu đề</label>
	                        ...
	                        <div class="col-md-12">
	                            <div class="form-group">
	                                ...
	                                <textarea name="content" style="width: 100%; height: 800px;"></textarea>
	                            </div>
	                        </div>
