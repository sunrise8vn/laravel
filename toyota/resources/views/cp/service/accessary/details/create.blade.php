...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Thêm nội dung phụ tùng chính hãng
      </h1>
      {{-- <ol class="breadcrumb">
        ...
        <div class="col-xs-12">
        	<div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
		            	<form action="{{ route('service.genuine-accessary-detail.postCreate') }}" method="POST" enctype="multipart/form-data">
		                    @csrf
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6" style=" padding: 10px 15px 20px 0;" id="btnSubmit">
                                    {{-- <button type="submit" class="btn btn-block btn-info btn-flat">
                                        <span class="glyphicon glyphicon-plus"></span> Thêm thông tin phụ tùng
                                    </button> --}}
                                </div>
                            </div>
		                </form>
	...
	<script type="text/javascript">
	    ...
	    function getListInfo(acc_id) {
            $.ajax({
                ...
                // url: "/api/cp/service/genuine-accessary/detail/getListInfo/" + acc_id,
                data : {
                        acc_id : acc_id,
                    },
                success: function(data) {
                    ...
                    document.getElementById("selGroup").innerHTML = text;
                    if(data.length > 0) {
                    	text = '';
                    	text += '<button type="submit" class="btn btn-block btn-info btn-flat">';
                        text += '<span class="glyphicon glyphicon-plus"></span> Thêm thông tin phụ tùng';
                        text += '</button>';
                    	document.getElementById("btnSubmit").innerHTML = text;
                    }
                    else {
                    	text = '';
                    	document.getElementById("btnSubmit").innerHTML = text;
