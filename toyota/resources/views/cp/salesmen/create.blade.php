        ...
        <div class="col-xs-12">
        	<div class="box">
                ...
                <div class="box-body">
	            	...
	            	<form action="cp/salesmen/create" method="POST" enctype="multipart/form-data">
	                    @csrf
	                    <div class="col-md-12">
                            <div class="form-group">
                                <label>Họ tên</label>
                            ...
                            <div class="form-group">
                              	...
                              	<select class="form-control" name='salesmenGroup'>
                                  	@foreach($salesmenGroup as $sg)
                                      	<option value="{{$sg->id}}">{{$sg->group}}</option>
                                  	@endforeach
                              	</select>
                          </div>
                        </div>
                        ...
                        <div class="col-md-12">
		                    <div class="col-lg-6" style="padding-top:20px">
		                    	<button type="submit" class="btn btn-block btn-info btn-flat">Thêm nhân viên</button>	
		                    </div>
	                    </div>
