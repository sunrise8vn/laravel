...
<body>
	<div class="slidePage slidePage-phukien">
        ...
        <div class="inner_popup_header">
            <span>Ngoại thất - {{$car->name}}</span>
        </div>
        <div class="inner_slidePage">
            <div class="slide_detail_mobile owl-carousel">
            	@foreach($carExteriors as $carEx)
                    <div class="item">
                        <p class="img">
                            <img class="galleryPopUp owl-lazy" data-src="/data/car/exterior/{{$car->id}}/{{$carEx->avatar}}" alt="">
                        </p>
                        <div class="txt_p">
                            <p class="txt_p_1">{{$carEx->title}}</p>
                            <div class="txt_p_2">
                                <p class="txt_dt">
                                    {{$carEx->description}}
                                </p>
