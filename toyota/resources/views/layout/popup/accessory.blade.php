...
<div class="slide_pc_on_popup_operate popup_item" id="popup_pc_accessory_00" style="display: none;">
                ...
                <div class="owl-item cloned" style="width: 980px; margin-right: 6px;">
                    <div class="item">
                        <div class="inner_item">
                            <p class="img">
                                <img src="/data/car/accessories/64/317-op-huong-gio-phia-truoc.png" alt="Ốp trang trí hõm cửa vân cacbon (1 bộ - 4 chiếc)">
                            </p>
                            <div class="txt_p">
                                <div class="txt_p_1">{{$carAcc->name}}</div>
                                <div class="txt_p_2">Giá: <strong>{{$carAcc->price}} <sup>VND</sup></strong><br></div>
