...
<div id="wrapper" class="bstyle1">
	...
	<div id="content">
		...
		@endif
	    <div class="grid gallery" style="position: relative;">
		            ...
		            <div class="grid-item" style="position: absolute; left: 0px;">
		                <a class="open_popup_pc" data-href="#popup_pc_gallery" data-index="{{$loop->index}}">
		                	@if($lib->video != null && $lib->video != "")
		                		...
		                		<img src="http://i3.ytimg.com/vi/{{$lib->video}}/hqdefault.jpg?w=450&amp;h=230&amp;mode=crop" alt="">
		                	@else
		                    <img src="/data/car/library/{{$car->id}}/{{$lib->avatar}}?w=450&amp;h=230&amp;mode=crop" alt="">
		                    @endif
		                </a>
		            </div>
