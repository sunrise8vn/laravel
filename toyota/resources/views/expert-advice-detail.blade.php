                            ...
                            {{-- @foreach($expertAdvice as $exAd) --}}
                                ...
                                <div class="social-row">
                                    <span class="item facebook">
                                        <a class="fbShare" onclick='window.open("https://www.facebook.com/sharer/sharer.php?u=https://toyotahue.co/loi-khuyen-chuyen-gia/{{$expertAdvice->permalink}}.html", "pop", "width=600, height=400, scrollbars=no");'>
                                            <i class="icon_fb"></i>
                                        </a>
                                    </span>
                                    <span class="item gplus">
                                        <a href="https://plus.google.com/share?url=https://toyotahue.co/loi-khuyen-chuyen-gia/{{$expertAdvice->permalink}}.html" onclick="javascript:window.open(this.href,'', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=650');return false;">
                            ...
                            <ul class="news others">
                                ...
                                @foreach($expertAdviceAnother as $exAdAno)
                                    <li class="item col s12">
                                        <div class="inner">
                                            <p class="img">
                                                <a href="/loi-khuyen-chuyen-gia/{{$exAdAno->permalink}}.html" title="{{$exAdAno->title}}" target="_parent">
                                            ...
                                            <div class="txt">
                                                <h3 class="title">
                                                    <a href="/loi-khuyen-chuyen-gia/{{$exAdAno->permalink}}.html" title="{{$exAdAno->title}}" target="_parent">{{$exAdAno->title}}</a>
                                                </h3>
