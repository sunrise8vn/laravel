...
{{-- <li class="item">
    <div class="inner">
        <div class="sm_checkbox">
            <input type="checkbox" class="checkCarTool" data-url="camry-2-5q" data-image="/data/car/thumb/237/iqkfet.png?width=500" data-caturl="camry" data-catid="64" data-name="CAMRY 2.5Q" data-price="1,234,999,999" data-idcar="237" id="checkbox-0237">
            <label for="checkbox-0237">
                <span class="img">
                    <img src="/data/car/thumb/237/iqkfet.png">
                </span>
                <span class="txt">
                    <span class="txt1">
                    ...
                    <span class="txt2">
                        <span class="name">CAMRY 2.5Q</span>
                        <span class="price">Giá từ: <span>1,234,999,999</span> <sup>VND</sup></span>
                    </span>
                </span>
            </label>
        </div>
...
<li class="item">
    <div class="inner">
        <div class="sm_checkbox">
            <input type="checkbox" class="checkCarTool" data-url="camry-2-5q" data-image="/data/car/thumb/237/iqkfet.png?width=500" data-caturl="Camry" data-catid="64" data-name="CAMRY 2.5Q" data-price="1,234,999,999" data-idcar="237" data-car="237" id="checkbox-0237">
            <label for="checkbox-0237">
                <span class="img">
                    <img src="/data/car/thumb/237/iqkfet.png">
                </span>
                <span class="txt">
                    ...
                    <span class="txt2">
                        <span class="name">CAMRY 2.5Q</span>
                        <span class="price">
                            Giá từ: <span>1,234,999,999</span> <sup>VND</sup>
                        </span>
                    </span>
                </span>
            </label>
